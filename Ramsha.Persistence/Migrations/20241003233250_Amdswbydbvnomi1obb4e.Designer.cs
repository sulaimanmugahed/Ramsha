...
namespace Ramsha.Persistence.Migrations
{
    ...
    [Migration("20241003233250_Amdswbydbvnomi1obb4e")]
    partial class Amdswbydbvnomi1obb4e
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Ramsha.Domain.Products.Entities.Discount", "Discounts", b1 =>
                        {
                            ...
                            b1.ToTable("InventoryItems_Discounts", "Core");

                            b1.WithOwner()
                                .HasForeignKey("InventoryItemId");
                        });

                    b.OwnsMany("Ramsha.Domain.Products.Entities.ProductPrice", "Prices", b1 =>
                        {
                            b1.Property<Guid>("InventoryItemId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("Ramsha.Domain.Products.Entities.Discount", "Discounts", b1 =>
                        {
                            ...
                            b1.HasKey("ProductVariantProductId", "ProductVariantId", "Id");

                            b1.ToTable("ProductVariant_Discounts", "Core");
